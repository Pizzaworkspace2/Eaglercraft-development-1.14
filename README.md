...
-
This is a 1.8.8 knockoff client with 1.13 and 1.14 features added. This client is written in Java and ported to JS using the batch file on linux. All assets and AI are ripped from the real game. Will be merged with 1.12.2 (hopefully)
